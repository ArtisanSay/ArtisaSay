...
- (void)jhCustomMenu:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 2) {
        NSLog(@"扫一扫");
        lhScanQCodeViewController *scanQCodeViewController = [[lhScanQCodeViewController alloc]init];
        UINavigationController *navController = [[UINavigationController alloc]initWithRootViewController:scanQCodeViewController];
